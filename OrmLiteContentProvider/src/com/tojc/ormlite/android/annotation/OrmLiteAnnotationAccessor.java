...
{
	/**
	 * Gets the table name from DatabaseTable annotation.
	 * If the DatabaseTable#tableName is not specified, returns the class name.
	...
	/**
	 * Gets the column name from DatabaseField annotation.
	 * If the DatabaseField#columnName is not specified, returns the field name.
	 * @param element Element to be evaluated.
