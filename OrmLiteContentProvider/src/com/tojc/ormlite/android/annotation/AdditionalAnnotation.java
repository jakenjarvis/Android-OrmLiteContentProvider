...
/**
 * It is the annotations that are added in OrmLiteContentProvider library.
 * It is also a class to manage their information.
 * 
 * @author Jaken
 */
...
{
	/**
	 * This specifies the default ContentUri.
	 * If you do not want to use the DefaultContentUri annotation, you must call the MatcherPattern#setContentUri().
	...
	/**
	 * This specifies the default MIME types(Provider-specific part only and vnd only).
	 * If you do not want to use the DefaultContentMimeTypeVnd annotation, you must call the MatcherPattern#setContentMimeTypeVnd().
	...
	/**
	 * Be used query method, if you do not specify how to sort.
	 * DefaultSortOrder annotation can be used in more than one field. In that case, specify the sort in ascending order of weight.
	 * If you omit the order, it will be in ascending order by default.
	 * If you specify the SortOrder.Asc, which explicitly grants the ASC.
	 * @author Jaken
	 */
	@Retention(RetentionPolicy.RUNTIME)
	...
	/**
	 * If you want to replace the column name, then you use the ProjectionMap annotation.
	 * You do not need to use it normally.
	 * Fields that do not specify a ProjectionMap annotation, set the default column name.
	 * If you take advantage of ProjectionMap annotation, use the following in onQuery().
	 * <br>ex)<br>
	 *     <code>
