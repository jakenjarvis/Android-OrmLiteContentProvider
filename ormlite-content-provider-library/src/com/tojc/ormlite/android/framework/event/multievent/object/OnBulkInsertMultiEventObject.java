 ...
 */
public class OnBulkInsertMultiEventObject extends MultiEventObjectBase {
    ...
    public OnBulkInsertMultiEventObject(Object source, OrmLiteSqliteOpenHelper helper, SQLiteDatabase db, MatcherPattern matcherPattern, Parameter parameter) {
        super(source);
        this.helper = helper;
        this.db = db;
