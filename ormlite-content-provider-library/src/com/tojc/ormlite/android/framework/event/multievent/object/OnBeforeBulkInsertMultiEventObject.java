 ...
 */
public class OnBeforeBulkInsertMultiEventObject extends MultiEventObjectBase {
    ...
    public OnBeforeBulkInsertMultiEventObject(Object source, OrmLiteSqliteOpenHelper helper, SQLiteDatabase db, MatcherPattern matcherPattern, Uri uri, List<ContentValues> values) {
        super(source);
        this.helper = helper;
        this.db = db;
