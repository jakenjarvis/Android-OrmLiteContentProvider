 ...
 * @since 1.0.5
 */
public abstract class WithoutTransactionControllerBase extends TransactionControllerBase implements TransactionGeneralControllerInterface {
    protected WithoutTransactionControllerBase() {
        super();
    }
