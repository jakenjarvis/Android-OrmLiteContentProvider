...
import com.tojc.ormlite.android.framework.transaction.controller.base.WithoutTransactionControllerBase;
 ...
 * @since 1.0.5
 */
public class DefaultTransactionOrganizer extends TransactionOrganizerBase {
    public DefaultTransactionOrganizer() {
        super();
    }
    ...
    protected TransactionGeneralControllerInterface createQueryTransactionController() {
        ...
        return new WithoutTransactionControllerBase() {
            @Override
