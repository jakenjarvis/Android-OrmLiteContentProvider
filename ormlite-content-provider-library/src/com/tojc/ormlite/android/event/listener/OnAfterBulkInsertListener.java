 ...
 */
public interface OnAfterBulkInsertListener<T extends OrmLiteSqliteOpenHelper> extends ContentProviderEventListenerInterfaceBase {
    /**
     * This method is called after the all onBulkInsert processing has been handled and
     ...
     * @since 2.0.0
     */
    void onAfterBulkInsert(T helper, SQLiteDatabase db, MatcherPattern target, Uri uri, List<ContentValues> values);
}
