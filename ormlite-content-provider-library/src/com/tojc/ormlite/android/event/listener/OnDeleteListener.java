 ...
 */
public interface OnDeleteListener<T extends OrmLiteSqliteOpenHelper> extends ContentProviderEventListenerInterfaceBase {
    /**
     * At the timing of delete() method, which calls the onDelete().
     * The implementation of the call timing, please refer to the source code of
     * com.tojc.ormlite.android.OrmLiteClassifierContentProvider#internalOnDelete.
     *
     ...
     */
    int onDelete(T helper, SQLiteDatabase db, MatcherPattern target, DeleteParameters parameter);
}
