...
public final class ExtendsAccountContract implements BaseColumns {

    private ExtendsAccountContract() {
        // utility constructor
    }

    public static final String AUTHORITY = "com.tojc.ormlite.android.test";

    public static final String CONTENT_URI_PATH = "extendsaccounts";

    public static final String MIMETYPE_TYPE = "extendsaccounts";
