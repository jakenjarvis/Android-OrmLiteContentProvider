...
public class OrmLiteSimpleProviderTestBase extends InstrumentationTestCase {

    protected static final String TEST_NAME_1 = "Yamada Tarou";
    protected static final String TEST_NAME_2 = "Stephane Nicolas";

    protected MockContentResolver resolver;
    protected UnderTestSampleProvider provider;

    protected UnderTestSampleFragment getContentProviderFragment(String key) {
        return (UnderTestSampleFragment)this.provider.getContentProviderFragments().get(key);
    }

   public void functionOnInsert() {
        // given
    ...
    public void functionOnQueryWithOrder() {
        // given
        Account account1 = new Account(TEST_NAME_1);
        Account account2 = new Account(TEST_NAME_2);
        RuntimeExceptionDao<Account, Integer> simpleDao = getHelper().getRuntimeExceptionDao(Account.class);
    ...
    public void functionContentProviderAcquisition() throws RemoteException {
        // given
        Account account1 = new Account(TEST_NAME_1);
        Account account2 = new Account(TEST_NAME_2);
        RuntimeExceptionDao<Account, Integer> simpleDao = getHelper().getRuntimeExceptionDao(Account.class);
    ...
    public void functionBulkInsert() {
        // given
    ...
    public void functionApplyBatch() throws RemoteException, OperationApplicationException {
        // given
    ...
    protected SampleHelper getHelper() {
