...
@MediumTest
public class TestOrmLiteSimpleProviderCase1 extends OrmLiteSimpleProviderTestBase {
    ...
    protected void setUp() throws Exception {
        ...
        this.provider = new UnderTestSampleProvider(1);
    ...
    public void testOnInsert() {
        ...
        assertEquals(this.getContentProviderFragment(TEST_FRAGMENT_KEY_NAME).getEventClassesList().size(), 0);
    }
